...
import {
    add_to_card, add_to_wishlist, messageClear,
...
const ShopProducts = ({styles, products}) => {
    ...
    return (<div
        className={`w-full grid ${styles === "grid" ? "grid-cols-4 md-lg:grid-cols-2 md:grid-cols-2" : "grid-cols-1 md-lg:grid-cols-2 md:grid-cols-2"} gap-3`}
    >
        ...
        >
            <div
                className={styles === "grid" ? "w-full relative group h-[210px] md:h-[270px] xs:h-[170px] overflow-hidden" : "md-lg:w-full relative group h-[210px] md:h-[270px] overflow-hidden"}
            >
                <img
            ...
            <div className="flex justify-center items-center cursor-pointer flex-col gap-1">
                <h2 className="text-md text-slate-700 uppercase font-medium">{p.name}</h2>
