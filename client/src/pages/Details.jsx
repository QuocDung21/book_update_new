...
const Details = () => {
    ...
    return (
        <div>
            <Headers/>
            <div
                className='bg-[url("http://localhost:3000/images/banner/2.jpg")] h-[410px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                                    ...
                                    {moreProducts.map((p, i) => {
                                        return (
                                            <Link to={`/product/details/${p.slug}`} className="block">
                                                ...
                                                <h2 className="text-slate-600 text-center uppercase font-bold py-1">{p.name}</h2>
            ...
            <section>
                <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
                    <h2 className="text-2xl uppercase py-8 text-slate-600">Sách tương tự</h2>
                    <div>
                        <Swiper
                            slidesPerView="auto"
                            breakpoints={{
                                        ...
                                        <Link className="block  " to={`/product/details/${p.slug}`}>
                                            <div className="relative h-[270px] ">
                                                <div className="w-full h-full">
                                                    ...
                                                    />
                                                    <div
                                                        className="absolute h-full w-full top-0 left-0 bg-[#000] opacity-25 hover:opacity-50 transition-all duration-500"></div>
                                                </div>
                                                {p.discount !== 0 && (
                                                    <div
                                                        className="flex justify-center items-center absolute text-white w-[38px] h-[38px] rounded-full bg-red-500 font-semibold text-xs left-2 top-2">
