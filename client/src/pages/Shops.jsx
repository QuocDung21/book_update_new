...
import {
    price_range_product, query_products,
...
const Shops = () => {
    const {
        products, totalProduct, latest_product, categorys, priceRange, parPage,
    ...
    useEffect(() => {
        dispatch(query_products({
            low: state.values[0], high: state.values[1], category, rating, sortPrice, pageNumber,
        }));
    ...
    return (<div>
        <Headers/>
        <section
            className='bg-[url("http://localhost:3000/images/banner/2.jpg")] h-[420px]  mt-6 bg-cover bg-no-repeat relative bg-left'>
