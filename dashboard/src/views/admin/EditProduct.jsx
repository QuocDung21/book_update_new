...
import {
    get_product, messageClear, update_product, product_image_update,
...
const EditProduct = () => {
    ...
    const changeImage = (img, files) => {
        if (files.length > 0) {
            dispatch(product_image_update({
                oldImage: img, newImage: files[0], productId,
            }));
        }
    };
    ...
    useEffect(() => {
        setState({
            ...
            brand: product.brand,
            stock: product.stock,
            loaibia: product.loaibia,
            sotrang: product.sotrang,
            nxb: product.nxb,
            nam_nxb: product.nam_nxb,
            kichthuocbaobi: product.kichthuocbaobi,
            ...
            <div>
                <form onSubmit={update}>
                    <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]">
                        ...
                        <div className="flex flex-col w-full gap-1">
                            <label htmlFor="brand">Tác giả</label>
                            <input
                                className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]"
                                onChange={inputHandle}
                                value={state.brand}
                        ...
                        <div className="flex flex-col w-full gap-1">
                            <label htmlFor="nxb">Năm xuất bản</label>
                            <input
                                className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]"
                                onChange={inputHandle}
                                value={state.nam_nxb}
                        ...
                        <div className="flex flex-col w-full gap-1">
                            <label htmlFor="loaibia">Loại bìa</label>
                            <input
                                className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]"
                                onChange={inputHandle}
                                value={state.loaibia}
                    ...
                    <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]">
                        ...
                        <div className="flex flex-col w-full gap-1">
                            <label htmlFor="discount">Trạng thái</label>
                    ...
                    <div
                        className="grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 xs:gap-4 gap-3 w-full text-[#d0d2d6] mb-4">
                    ...
                    <div className="flex">
                        ...
                        >
                            {loader ? (<PropagateLoader color="#fff"
                                                        cssOverride={overrideStyle}/>) : ("Cập nhật sản phẩm")}
                        </button>
                        <div className="m-1">
                        ...
                        >
                            {loader ? (<PropagateLoader color="#fff"
                                                        cssOverride={overrideStyle}/>) : ("Trở về")}
                        </button>
                    </div>
                </form>
            </div>
