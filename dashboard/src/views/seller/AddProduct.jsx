...
const AddProduct = () => {
  ...
  const add = (e) => {
    ...
    formData.append("loaibia", state.loaibia);
    formData.append("sotrang", state.sotrang);
    formData.append("nxb", state.nxb);
    formData.append("nam_nxb", state.nam_nxb);
    formData.append("kichthuocbaobi", state.kichthuocbaobi);
    formData.append("trongluong", state.trongluong);
    ...
    <div className="px-2 lg:px-7 pt-5 ">
      <div className="w-full p-4  bg-[#283046] rounded-md">
        <div className="flex justify-between items-center pb-4">
          <h1 className="text-[#d0d2d6] text-xl font-semibold">Thêm sách</h1>
          <Link
